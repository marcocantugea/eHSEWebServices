...
Namespace com.database
    Public Class OleDBConnectionObj
        ...
        Protected connection As com.database.ConnectionsProperty
        ...
        Public Sub New()
            ...
            For Each s As String In System.Configuration.ConfigurationSettings.AppSettings
                If s.Contains("DB-") Then
                    cont = True
                    Dim con As New com.database.ConnectionsProperty
                    con.Name = s
        ...
        Public Sub New(ByVal ConnectionProperty As com.database.ConnectionsProperty)
