    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Page.IsPostBack() Then
            ...
            If (dts Is Nothing) Then
                Page.Response.Write("No Work Activities add it to this TRA")
            Else
                Dim bindDs_name As String = "qryTRATest" 'Dim bindDs_name As String = "qryTRATest"
                Dim reportName As String = "Reports/TRA_Format.rdlc" 'Dim reportName As String = "Reports/Report.rdlc" 'Report.rdlc
