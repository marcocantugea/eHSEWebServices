                        ...
                        <table style="width:900px; height: 0px;">
                            <tr>
                                <td class="auto-style2">
                                    <asp:Label ID="lDepartamento" runat="server" Font-Bold="True" Font-Names="Myriad Pro" Font-Size="Medium" Font-Strikeout="False" Text="Department:"></asp:Label>
                            ...
                            <tr>
                                <td class="auto-style2">
                                    <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Myriad Pro" Font-Size="Medium" Font-Strikeout="False" Text="TRA Description:"></asp:Label>
                                    <asp:TextBox ID="tSrcDescription" runat="server" Font-Names="Myriad Pro" Font-Size="Medium" Font-Strikeout="False" Width="200"></asp:TextBox>
                                    <asp:Label ID="Label5" runat="server" Visible="False" ></asp:Label>
                                    <asp:Label ID="Label6" runat="server" Visible="False" ></asp:Label>
                                </td>
                                <td style="text-align: right" class="auto-style6">
                                   <asp:Button ID="btnBorradores" runat="server" BackColor="#555555" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Font-Names="Myriad Pro" Font-Size="Medium" ForeColor="White" Height="30px" Text="Drafts" Width="100px" />
&nbsp;<asp:Button ID="btnOnRevision" runat="server" BackColor="#555555" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Font-Names="Myriad Pro" Font-Size="Medium" ForeColor="White" Height="30px" Text="On Revision" Width="100px" />
&nbsp;<asp:Button ID="btnOficiales" runat="server" BackColor="#555555" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Font-Names="Myriad Pro" Font-Size="Medium" ForeColor="White" Height="30px" Text="Oficials" Width="100px" />
