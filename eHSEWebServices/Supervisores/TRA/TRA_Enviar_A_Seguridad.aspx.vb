...
Imports System.Data
Partial Class TRA_TRA_Enviar_A_Seguridad
    ...
    Protected Sub enviarBorrador()
        ...
        Email.From = New MailAddress("e-tra@grm4.com", "e-TRA - Bicentenario")
        Email.Priority = MailPriority.High

        Email.To.Add(New MailAddress("RSTC@grm4.com"))
        Email.CC.Add(New MailAddress("it@grm4.com"))
    ...
    Function cuerpoCorreo() As String
        ...
        "<tr><td height=""73""> " & _
            "<table width=""81"" height=""49"" align=""center"" border=""0"" cellpadding=""0"" cellspacing=""0"">" & _
                "<tr>" & _
                    ...
                    "<td><a href=""http://192.168.45.6/RSTC/TRA/main.aspx""><img src=""'cid:Image2'"" style=""height: 46px; width: 174px"" /></td>" & _
                "</tr>" & _
            "</table>" & _
            "</td></tr>" & _
        "<tr><td height=""122"" align=""left"" valign=""middle"" style=""font-family: Verdana; font-size: small; font-weight: bold; font-style: normal;""><blockquote>" & _
            "<p>" & _
            "Se ha creado un nuevo TRA con el ID # - " & ltraId.Text & " -  del departamento " & lDepartamento.Text & " y se ha mandado " & _
        ...
        "<tr><td></td><td><a href=""http://192.168.45.6/RSTC/TRA/TRA_Convertir_Oficial.aspx?Param=" & ltraId.Text & """><img src=""'cid:Image3'"" style=""height: 39px; width: 156px"" /></td><td></td></tr>" & _
        "<tr><td></td><td></td><td></td></tr>" & _
        "</table>" & _
        "</td></tr>" & _
