...
Partial Class TRA_main
    ...
    Protected Sub fillTRAsByDeptOnRevision()
        ...
        Dim dts As DataSet
        Dim Sql As String
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Authority' and tra_Dept='" & UsuarioDepartamento() & "' ORDER BY tra_ID ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
    ...
    Protected Sub fillTRAsByDeptOficials()
        ...
        Dim dts As DataSet
        Dim Sql As String
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Oficial' and tra_Dept='" & UsuarioDepartamento() & "' ORDER BY tra_ID ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
