    ...
    <div class="content-fliud text-inline border bg-warning">
        <div class="content border-top border-bottom border-primary p-2">
            <div class="row">
                ...
                <div class="col text-left bg-white p-2 rounded-lg rounded-left border border-primary">
                    <span >
                    <a class="h6" href="index.aspx?p=p_createsoc"><span  class="display-4" id="lbl_index_createsoc_titile" > <% Response.Write(lang_configreader.GetValue("p_index_lbl_createsoc"))%></span>
                             <br /> <br /> <span  class="h4" id="lbl_index_createsoc" ><% Response.Write(lang_configreader.GetValue("p_index_lbl_createsoc_subtext")) %></span></a>
                            <br /> <span  class="h5" id="lbl_index_textsoc"> <% Response.Write(lang_configreader.GetValue("p_index_lbl_createsoc_text")) %></span>
                    </span>
                </div>
              </div>
        </div>
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col text-left">
                       ...
                       <a href="index.aspx?p=p_tras"> <img src="../images/tra_electronic.JPG" class="img-thumbnail mb-3" /></a>
                    </div>
                    <div class="col">
                        <span class="h4 m-0">
                ...
                <div class="row">
                    <div class="col">
                        <span class="h4">
                           <%Response.Write(lang_configreader.GetValue("p_index_lbltext1"))%><a href="index.aspx?p=p_tras"><%Response.Write(lang_configreader.GetValue("p_index_lbltext2"))%></a> 
                        </span>
                    </div>
                </div>
            </div>
