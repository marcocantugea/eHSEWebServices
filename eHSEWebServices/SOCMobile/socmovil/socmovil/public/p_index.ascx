...
<div class="content text-center">
    <div class="content  border p-2">
        <span class="display-3" id="lbl_index_topmain"><% Response.Write(Pagelang_configreader.GetValue("p_index_lbl_maintoptitle"))%></span>
    </div>
            ...
            <div class="row m-0">
              <div class="col text-right bg-warning ">
                ...
                <div class="col text-left bg-white rounded-lg rounded-left border border-primary">
                    <span>
                        <a class="h6" href="index.aspx?p=soc/p_createsoc"><span class="display-4" id="lbl_index_createsoc_titile"><% Response.Write(Pagelang_configreader.GetValue("p_index_lbl_createsoc"))%></span>
                            <br />
                            <br />
                            <span class="h4" id="lbl_index_createsoc"><% Response.Write(Pagelang_configreader.GetValue("p_index_lbl_createsoc_subtext"))%></span></a>
                        <br />
                        <span class="h5" id="lbl_index_textsoc"><% Response.Write(Pagelang_configreader.GetValue("p_index_lbl_createsoc_text"))%></span>
                    </span>
                </div>
            </div>
        </div>
...
<div id="TRAMainDiv" class="container-fluid border-top border-bottom" style="height: 700px; background-image: url('../images/background_electronic_tra.jpg'); background-size: cover; background-position: center center;">
    <div class="container text-center rounded-lg border border-primary pt-2 pb-3" style="margin-top: 5%; background-color: white; opacity: .96;">
        <span class="text-primary display-4"><%Response.Write(Pagelang_configreader.GetValue("p_index_lbltramain"))%></span>
        <div class="container" style="">
            <div class="row">
                <div class="col text-left">
                    <span class="h4 m-0">
                        <%Response.Write(Pagelang_configreader.GetValue("p_index_lbltrasubtitile"))%>
                    </span>
                ...
                <div class="col">
                    <span class="h4 m-0">
                        <%Response.Write(Pagelang_configreader.GetValue("p_index_lblhowtocreatetra"))%>
                    </span>
                    <video controls="controls" width="520" preload="metadata">
                        <source src="../media/TRA-ES-Crear%20nuevo.mp4#t=1" type="video/mp4">
                    </video>
                    <span class="h5">
                        <a href="index.aspx?p=tutorials/tutorials"><%Response.Write(Pagelang_configreader.GetValue("p_index_lblmoretutorials"))%></a>
                    </span>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <span class="h4">
                        <%Response.Write(Pagelang_configreader.GetValue("p_index_lbltext1"))%><a href="index.aspx?p=tra/p_tras"><%Response.Write(Pagelang_configreader.GetValue("p_index_lbltext2"))%></a>
                    </span>
                </div>
            </div>
        </div>
