...
<% 
    ...
    If Request.HttpMethod = "POST" Then
        ...
        If Request.Form("unsafeact") = Pagelang_configreader.GetValue("lbl_yes") Then
        ...
        If Request.Form("stopjob") = Pagelang_configreader.GetValue("lbl_yes") Then
        ...
        If Request.Form("informsupervisor") = Pagelang_configreader.GetValue("lbl_yes") Then
    ...
    If saveinfo Then
        Response.Redirect("index.aspx?p=soc/t_createsoc")
    End If
%>
...
<div class="container text-center mt-2 p-2 border border-danger" >
   <p class="h3"><% GetLbl("p_createsoc_lbl_createsoc")%> </p>
   <div class="row">
       <div class="col text-left">
           <button type="button" class="btn btn-success btn-lg btn-block"  id="btn_saveinfotop"> <% GetLbl("lbl_yes")%>  </button>
       </div>
       <div class="col text-rigth">
           <button type="button" class="btn btn-danger btn-lg btn-block"  id="btn_nosavetop"> <% GetLbl("lbl_no")%>  </button>
       </div>
   </div>
</div>
<%
...
<form id="frm_createsoc" action=""  class="m-2 p-2 border bg-white needs-validation" method="post" novalidate >
     <div class="form-group">
        ...
        <input type="text" class="form-control" id="namecontrol" placeholder="" name="name" required  value="<% If Load_info Then Response.Write(capt_soc.Nombre) Else If name_by_cookie.Length > 0 Then Response.Write(name_by_cookie)%>">
         <div class="invalid-feedback">
            <% GetLbl("p_createsoc_lbl_titile_invalidname")%>
        </div>
     </div>
    <div class="form-group">
        ...
        <div class="invalid-feedback">
            <% GetLbl("p_createsoc_lbl_titile_invalidlocation")%>
        </div>
     </div>
    <div class="form-group">
        ...
        <div class="invalid-feedback">
            <% GetLbl("p_createsoc_lbl_titile_invalidobservation")%>
        </div>
     </div>
    <div class="form-group">
        ...
        <select class="form-control" id="unsafeactcontrol" name="unsafeact">
          <option <% If capt_soc.Acto_Inseguro Then Response.Write("selected")%>><% GetLbl("lbl_yes")%></option>
          <option <% If not capt_soc.Acto_Inseguro Then Response.Write("selected")%> ><% GetLbl("lbl_no")%></option>
        </select>
    </div>
    <div class="form-group">
        ...
        <textarea class="form-control" id="conserncontrol" name="consern" required rows="4"><% If Load_info Then Response.Write(capt_soc.Situation)%></textarea>
         <div class="invalid-feedback">
            <% GetLbl("p_createsoc_lbl_titile_invalidconsern")%>
        </div>
     </div>
    <div class="form-group">
        ...
        <select class="form-control" id="stopjobcontrol" name="stopjob">
          <option <% If capt_soc.StopJob Then Response.Write("selected")%> ><% GetLbl("lbl_yes")%></option>
          <option <% If not capt_soc.StopJob Then Response.Write("selected")%>><% GetLbl("lbl_no")%></option>
        </select>
    </div>
    ...
    <div class="form-group mt-2">
        ...
        <div class="invalid-feedback">
           <% GetLbl("p_createsoc_lbl_titile_invalidactiontaken")%>
        </div>
     </div>
     ...
     <div class="form-group mt-2">
        ...
        <textarea class="form-control" id="actionmitigateriskcontrol" name="actionmitigaterisk" required  rows="4"><% If Load_info Then Response.Write(capt_soc.MinimizeRisk)%></textarea>
          <div class="invalid-feedback">
           <% GetLbl("p_createsoc_lbl_titile_invalidactionmitigaterisk")%>
        </div>
     </div>
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="informsupervisorcontrol" name="informsupervisor">
          <option <% If capt_soc.InformSupervisor Then Response.Write("selected")%>><% GetLbl("lbl_yes")%></option>
          <option  <% If Not capt_soc.InformSupervisor Then Response.Write("selected")%>><% GetLbl("lbl_no")%></option>
        </select>
    </div>
    <button type="submit" class="btn btn-primary btn-lg btn-block"> <% GetLbl("p_createsoc_lbl_continue")%> </button>
...
<div class="container text-center mt-2 p-2 border border-danger">
   ...
   <div class="row ">
       <div class="col text-left">
           <button type="button" class="btn btn-success btn-lg btn-block" id="btn_saveinfo"> <% GetLbl("lbl_yes")%> </button>
       </div>
       <div class="col text-rigth">
           <button type="button" class="btn btn-danger btn-lg btn-block" id="btn_nosave"> <% GetLbl("lbl_no")%>  </button>
       </div>
   </div>
</div>
<%
