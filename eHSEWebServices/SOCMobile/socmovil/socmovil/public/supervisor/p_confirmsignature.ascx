...
<div class="container text-center">
    <div>
        <span class="display-4"><%GetLbl("p_confirmsignature_lbl_maintitle")%></span>
        <% If show_errorpass Then%>
        <div class="bg bg-danger text-white p-3 mt-2 mb-2 ">
           <span class="h4"> <%GetLbl("p_confirmsignature_lblerror_passwordnovalid") %></span>
        </div>
        <% end if %>
        <div class="container ">
           <%-- <div class="row ">--%>
               ...
               <%-- <div class="col  mr-5 inline ">
                ...
                <div class="container mt-4 mb-4" style="width:500px;" >
                    ...
                    <div class="rounded bg p-3" style="background-color:#f1f2f6; border:1px solid #636e72;">
                        <span class="h4"><%GetLbl("p_confirmsignature_lbltypeyourpassword") %></span>
                        <div class="form-group mt-3">
                            <label for="password"><%GetLbl("p_confirmsignature_lblpasswordsignature") %></label>
                            <input type="password" class="form-control text-center" id="password" name="password" placeholder="" required>
                            <button type="submit" class="btn btn-success btn-lg mt-3"> <%GetLbl("lbl_accpet")%> </button>
