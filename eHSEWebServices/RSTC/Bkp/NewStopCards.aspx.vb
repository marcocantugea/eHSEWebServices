...
Partial Class NewStopCards
    ...
    Protected Sub btnUpdate0_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate0.Click
        ...
        Dim filename As String = path & "images\LogotipoIPC.jpg"
        ...
        Email.From = New MailAddress("safety.BIC@grupor.com.mx", "SOC - Bicentenario")
        ...
        If dts.Tables(0).Rows.Count > 0 Then
            For Each row As DataRow In dts.Tables(0).Rows
                ...
                Else
                    'Email.To.Add(New MailAddress("it.BIC@grupor.com.mx"))
                    If row("correo") = "it.BIC@grupor.com.mx" Then
        ...
        Try
            ...
            New System.Net.NetworkCredential("it.BIC@grupor.com.mx", "cbkjst11")
            'Put your own, or your ISPs, mail server name onthis next line
            mailClient.Host = "smtp.grupor.com.mx"
...
"</tr><tr>" & _
        ...
        "Style = ""font-family: Verdana; font-size: x-small; font-weight: normal; font-style: normal; color: #333333""" & _
                ...
                "</b>Ext.:3044<br/>" & _
                "EMail: Safety.Bic@grupor.com.mx</td>" & _
                "</tr>" & _
    "</table>" & _
    "</td>" & _
    "</tr>" & _
    "<tr>" & _
        "<td Style = ""font-family: Verdana; font-size: x-small; font-weight: normal; font-style: normal; color: #333333"">Powered By Jhonny Rivers</td>" & _
    "</tr>" & _
"</table>"
        Return cuerpo
    End Function
