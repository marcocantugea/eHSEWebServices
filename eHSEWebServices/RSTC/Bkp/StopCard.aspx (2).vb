...
Partial Class StopCard
    ...
    Protected Sub gvEmpleados_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles gvEmpleados.RowCommand
        Dim a As String
        a = gvEmpleados.SelectedRow.Cells().ToString()
        txtName.SelectedValue = gvEmpleados.SelectedRow.Cells(1).ToString
    End Sub
    ...
    End Sub
    Protected Sub btnPhoneSrc_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPhoneSrc.Unload
        If Page.IsPostBack Then
            btnPhoneSrc.Enabled = False
        End If
    End Sub

    Protected Sub btnPhoneSrc0_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPhoneSrc0.Click
