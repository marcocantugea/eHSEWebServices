<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRA_Enviar_Devolucion.aspx.vb" Inherits="TRA_TRA_Enviar_Devolucion" %>
...
<body style="margin:0px 0px 0px 0px;font-family: verdana; font-size: x-small; font-weight: bold; font-style: italic; font-variant: normal; color: #990000">
    ...
    <div style="font-family:Verdana; font-size:small ">
        ...
        <td>
            ...
            <tr>
                <td class="style2">
                    <table style="border: thin ridge #808080; width: 905px;">
                        ...
                        <tr>
                            <td class="auto-style11">
                                <asp:Label ID="lEnviarRev_Success0" runat="server" Text="l" Font-Names="Arial" style="font-size: small" Width="595px"></asp:Label>
                            </td>
            ...
            <asp:Label ID="lRazon" runat="server" Text="ID" Visible="False"></asp:Label>
                            </td>
