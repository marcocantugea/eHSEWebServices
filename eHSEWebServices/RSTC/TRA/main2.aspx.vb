...
Partial Class TRA_main2
    ...
    Protected Sub fillTRAsByDeptDrafts()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Draft' and tra_Dept like '%" & criterio & "%' and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_ID ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
    ...
    Protected Sub fillTRAsByDeptOnRevision()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Safety' and tra_Dept like '%" & criterio & "%'  and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_ID ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
    ...
    Protected Sub fillTRAsByDeptOficials()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Oficial' and tra_Dept like '%" & criterio & "%'  and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_ID ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
    ...
    Protected Sub fillTRAsByDeptDelete()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Pending_Delete' and tra_Dept like '%" & criterio & "%'  and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_ID ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
