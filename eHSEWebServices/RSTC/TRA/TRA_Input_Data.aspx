<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRA_Input_Data.aspx.vb" Inherits="TRA_Input_Data"%>
...
.button1{
	...
	background-color: #D83232;		/* changed background color to a nice blue */
...
#popup {
	...
	.button1:hover {
	    background-color: #333333;  /* changed the bg-color to transparent */
	  border: 0.15em #333333 solid;	/* set a border to a blue color */
	  color: white;					/* set a text color to the same color */
	}
    .button1:active {
	background-color: transparent;  
	border: 0.15em #FFfff solid;	
    background-color: #AB2121;					/* minor text color change in a deeper blue */
}
	...
	color: white;					/* changed text color to white */
				/* increased padding for a larger button */
	background-color: #24BD37;		/* changed background color to a nice blue */
	text-transform: uppercase;		/* made the text uppercase */
	font-weight: bold;				/* gave the text a bold look */
	...
	border: 0.15em #1C932B solid;	
	color: #fff;					 minor text color change in a deeper blue */
}
...
<body style="margin:0px 0px 0px 0px;font-family: verdana; font-size: x-small; font-weight: bold; font-style: italic; font-variant: normal; color: #990000">
    ...
    <table style="width: 650px;" align="center">
                ...
                <tr  cellpadding="3" cellspacing="6" >
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align:top; text-align:left ">
                                            <asp:Label ID="Label1" runat="server" 
                                                Text="Descripction" Width="534px"></asp:Label>
                                        </td>
                                        <td style="vertical-align:top;">
                                            <asp:Label ID="Sel" runat="server" 
    ...
    <table style="vertical-align:bottom " align="center">
       ...
       <table style="width: 671px; font-family:Verdana; font-size:xx-small; " border="0" 
        ...
        <td class="auto-style1" style="border-bottom-style: solid; border-bottom-width: thick; border-bottom-color: #000000;"><asp:Image ImageAlign="Top" ID="Image1" runat="server" ImageUrl="~/Images/tra_Header.png" />
            <asp:Label ID="ltraId" runat="server"></asp:Label>
                             
                    <asp:Label ID="TraR_ID" runat="server" style="font-size: xx-small"></asp:Label>
                    ...
                    <table style="border: thin ridge #808080; width: 1298PX;">
                        <tr>
                            ...
                            <td class="auto-style37" rowspan="4">
                                <asp:Button ID="btnAddTRA" runat="server" CssClass="button " Text="Create New TRA" Height="81px" style="margin-top: 0px" Width="263px" OnClick="btnAddTRA_Click"/>
                                <asp:Button ID="btnClone" runat="server" CssClass="button " Text="Clone TRA" Height="81px" style="margin-top: 0px" Width="263px" OnClick="btnAddTRA_Click" Visible="False"/>
                                              </tr>
                        <tr>
                            <td class="auto-style11">
                            ...
                            <td>
                              ...
                              <tr>
                                <td ALIGN="center" style="vertical-align:top;">
                                        <asp:Label ID="lConsecutivoTras" runat="server" Width="30px"></asp:Label>
                                    </td>
                                    <td style="vertical-align:top;">
                                ...
                                <asp:Button ID="bSaveTask" runat="server" CssClass="button" Text="Save" 
                                    Width="150px" Height="25px" Font-Size="X-Small" TabIndex="292"/>
                                        <br />
                                ...
                                <td ALIGN="center" style="vertical-align:top;">
                                   ...
                                   <td style="vertical-align:top;">
                                      <asp:ImageButton ID="ImageButton4" runat="server" ImageUrl="~/Images/rpt_Up.png" 
                                          CommandArgument='<%#Container.DataItem("tra_ID")%>' CommandName="bUp"
                                          />
                                      <td style="vertical-align:top;">
                                      <asp:ImageButton ID="ImageButton5" runat="server" ImageUrl="~/Images/rpt_Down.png" 
                                          CommandArgument='<%#Container.DataItem("tra_ID")%>' CommandName="bDown"
                                          />
                                    <td style="vertical-align:top;">
                                      <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/rpt_Modificar.png" 
                                          CommandArgument='<%#Container.DataItem("tra_ID")%>' CommandName="bModify" 
                                          />
                                    </td>
                                  <td style="vertical-align:top;">
                                      <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Images/rpt_Eliminar.png" 
                                          CommandArgument='<%#Container.DataItem("tra_ID")%>' CommandName="bDelete"
                                          />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table style="margin:0; padding:0;border:0;" class="repeaterAlterno">
                              <tr>
                                <td ALIGN="center" style="vertical-align:top;">
                                  ...
                                  <td style="vertical-align:top;">
                                      <asp:ImageButton ID="ImageButton3" runat="server" ImageUrl="~/Images/rpt_Eliminar.png" 
                                      CommandArgument='<%#Container.DataItem("tra_ID")%>' CommandName="bDelete"/>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <tr>
                            ...
                            <td class="auto-style45">
                                <asp:RadioButtonList ID="RadioButtonList1"  runat="server" Width="350px" RepeatDirection="Horizontal" Font-Size="XX-Small" CssClass="style26">
                                    <asp:ListItem Value="rb1">N/A</asp:ListItem>  <asp:ListItem Value="rb2">Assessed</asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td class="auto-style43">
                                <asp:RadioButtonList ID="RadioButtonList2" runat="server" CssClass="style26" Width="350px" RepeatDirection="Horizontal">
                                    <asp:ListItem Value="rb1">N/A</asp:ListItem>
                ...
                <td >
                    <table runat="server" id="tbl_TRAMain3" style="border: thin ridge #808080; width: 1298PX;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style38" style="vertical-align:middle">
                                <asp:TextBox ID="txtProcedure" runat="server" CssClass="estiloEtiquetasA" 
                                    Height="19px" Width="300px"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            &nbsp;&nbsp;
                                <asp:Button ID="btnPrint" runat="server" Text="Print / Imprimir" CssClass="Button" 
                                    Height="35px" Width="155px" TabIndex="50"/>    
                               
                               &nbsp;
                                <asp:Button ID="btnPhoneSrc0" runat="server" Text="Send to Review / Enviar a Revision" CssClass="buttonGreen" 
                                    Height="35px" Width="288px" TabIndex="50" OnClick="btnPhoneSrc0_Click"/>                                 
    ...
    <script>
        function DisableButton2() {
            document.getElementById("<%=btnAddTRA.ClientID%>").disabled = true;
                }
                window.onbeforeunload = DisableButton;
    </script>
</body>
