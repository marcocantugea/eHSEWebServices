...
Partial Class TRA_main
    ...
    Protected Sub fillTRAsByDept()
        ...
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status<>'Oficial' and tra_Dept like '%" & criterio & "%'  ORDER BY tra_Activity_Job ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
        lblStatus.Text = "DRAFTS"
    ...
    Protected Sub fillTRAsByDeptDrafts()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status<>'Oficial' and tra_Dept like '%" & criterio & "%' and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_Activity_Job ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
    ...
    Protected Sub fillTRAsByDeptOnRevision()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Safety' and tra_Dept like '%" & criterio & "%'  and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_Activity_Job ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()
    ...
    Protected Sub fillTRAsByDeptDelete()
        ...
        Else
            criterio = dbDepartamento.SelectedItem.Text
        End If
        Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords where tra_Status='Pending_Delete' and tra_Dept like '%" & criterio & "%'  and tra_Activity_Job like '%" & tSrcDescription.Text & "%' ORDER BY tra_Activity_Job ASC"
        dts = clsDB.QueryDataSet(Sql)
        clsDB.Close()

        lblStatus.Text = "WAITING FOR DELETE"
        'dtsItems.Tables.Add(Lista)
    ...
    Protected Sub dbDepartamento_SelectedIndexChanged(sender As Object, e As EventArgs) Handles dbDepartamento.SelectedIndexChanged
        ...
        '    Sql = "SELECT tra_ID,tra_Dept,tra_Activity_Job FROM traRecords Where tra_Dept like '%" & criterio & "%' and tra_Status='Oficial' ORDER BY tra_Activity_Job ASC"
        '    lblStatus.Text = "OFICIAL"
