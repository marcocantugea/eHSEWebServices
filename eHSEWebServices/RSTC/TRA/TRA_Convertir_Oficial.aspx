<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRA_Convertir_Oficial.aspx.vb" Inherits="TRA_TRA_Convertir_Oficial" %>
    ...
    <table  style="border: thick solid #000000; width:500px; height:200px; background:#fff; vertical-align:bottom;" align="center">
       ...
       <table style="width: 671px; font-family:Verdana; font-size:xx-small; " border="0" 
        ...
        <td class="auto-style1" style="border-bottom-style: solid; border-bottom-width: thick; border-bottom-color: #000000;"><asp:Image ImageAlign="Top" ID="Image1" runat="server" ImageUrl="~/Images/tra_Header.png" />
            <asp:Label ID="ltraId" runat="server" Visible="False"></asp:Label>
           ...
           <tr >
               <td style="height:30px; color:white; background:#800000; padding:8px; margin:2px; font-size:small; ">
                   <table width="100%" border="0" cellspacing="0" cellpadding="3">
  <tr>
    <td width="50%"><asp:Label ID="lblDeptAuthority" runat="server" Text="Revision by Safety Department" ></asp:Label></td>
                            ...
                            <td>
                              ...
                              <tr>
                                <td ALIGN="center" style="vertical-align:top;" class="auto-style50">
                                        <asp:Label ID="lConsecutivoTras" runat="server" Width="30px">0</asp:Label>
                                    </td>
                                    <td style="vertical-align:top;">
                    ...
                    <table runat="server" id="tbl_TRAMain3" style="border: thin ridge #808080; width: 1298PX;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style40">
                                ...
                                &nbsp;                         
                                <asp:Button ID="btnRegresar" runat="server" Text="Send Back / Regresar" CssClass="button" 
                                    Height="35px" Width="185px" TabIndex="50" Visible="true"/>                                 
                            &nbsp;&nbsp;
                                <asp:Button ID="btnPrint" runat="server" Text="Print / Imprimir" CssClass="buttonGreen" 
                                    Height="35px" Width="155px" TabIndex="50"/>    
                                 &nbsp;
                                <asp:Button ID="btnPhoneSrc0" runat="server" Text="Aprove TRA" CssClass="buttonGreen" 
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:Table runat="server" ID="tRazon" Visible="False">
                                    <asp:TableRow CssClass="button1">
                                        <asp:TableCell CssClass="auto-style11" Width="250">
                                            <asp:Label ID="lRazon" runat="server" Text="Reject Reason:"></asp:Label>
                                        </asp:TableCell>
                                        <asp:TableCell CssClass="auto-style40">
                                             <asp:TextBox ID="txtRazon" runat="server" Width="450" TextMode="MultiLine"></asp:TextBox>
                                            &nbsp; 
                                            <asp:Button ID="bRejectConfirm" runat="server" Text="OK" CssClass="button" 
                                    Height="35px" Width="140px" TabIndex="50" Visible="true"/> 
                                            &nbsp; 
                                            <asp:Button ID="bRejectCancel" runat="server" Text="Cancel" CssClass="button1" 
                                    Height="35px" Width="140px" TabIndex="50" Visible="true"/> 
                                        </asp:TableCell>
