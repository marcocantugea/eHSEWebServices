...
Imports System.Data
Partial Class TRA_TRA_Enviar_Devolucion
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not Page.IsPostBack Then
            Try
                ...
                lRazon.Text = Request.QueryString("Razon").ToString
    ...
    Protected Sub enviarBorrador()
        ...
        Try
            ...
            lEnviarRev_Success0.Text = "Your document is been sent to Department Authority to be Reviewed."
        Catch ex As Exception
    ...
    Function cuerpoCorreo() As String
        ...
        "<tr><td height=""122"" align=""left"" valign=""middle"" style=""font-family: Verdana; font-size: small; font-weight: bold; font-style: normal;""><blockquote>" & _
            "<p>" & _
            "Safety Department is been sent back an a TRA with the ID - " & ltraId.Text & " - from " & lDepartamento.Text & " Department Back " & _
            "to your email for your revision and comments. The reason of this sent back is: " & lRazon.Text & "" & _
            "</p>" & _
            "<p>" & _
            "To procede with the revision please click on the next hyperlink." & _
          "</p>" & _
            "</blockquote></td>" & _
        "</tr>" & _
        "<tr><td>" & _
        ...
        "<tr><td></td><td><a href=""http://localhost:2468/TRA/TRA_Revision_1.aspx?Param=" & ltraId.Text & """><img src=""'cid:Image3'"" style=""height: 39px; width: 156px"" /></td><td></td></tr>" & _
        "<tr><td></td><td></td><td></td></tr>" & _
        "</table>" & _
        "</td></tr>" & _
