<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRA_Enviar_Revision.aspx.vb" Inherits="TRA_TRA_Enviar_Revision" %>
            ...
            <tr>
                <td class="style2">
                    <table style="border: thin ridge #808080; width: 905px;">
                        ...
                        <tr>
                            <td class="auto-style11">
                                <asp:Label ID="lEnviarRev_Success0" runat="server" Text="Your document is been sent to Department Authority to be approved to become official." Font-Names="Arial" style="font-size: small" Width="595px"></asp:Label>
                            </td>
                    ...
                    <table style="border: thin ridge #808080; width: 901px;">
                        <tr>
                            <td class="auto-style29">
                                Powered by Bicentenario IT Servicesrvicesrvicesrvices</td>
                        </tr>
                        </table>
                </td>
            </tr>
