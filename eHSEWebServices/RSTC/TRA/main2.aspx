<%@ Page Language="VB" AutoEventWireup="false" CodeFile="main2.aspx.vb" Inherits="TRA_main2" %>
    ...
    <div id="overlay" runat="server"></div>
        <div id="popup">
            <div runat="server" id="divConfirmación">
                <table  style="border: thick solid #000000; width:500px; height:200px; 
background:#fff; vertical-align:bottom;" align="center">
                    <tr>
                        <td>
                            <asp:Label ID="Label26" runat="server" Text="The TRA is going to 
be Delete. Are you sure?" CssClass="estiloTitulos"></asp:Label>
                        </td>
                    </tr>
                    <tr align="center"> 
                        <td>
                            <asp:Button ID="bDeleteTareaConfirm" runat="server" 
CssClass="button1" Height="35px" Text="DELETE TRA" Width="200px" />
                        </td>
                    </tr>
                    <tr align="center">
                        <td>
                            <asp:Button ID="btnEliminarNo" runat="server" CssClass="button" 
Text="Cancel" Height="35px" Width="200px" />
                        </td>
                    </tr>
                </table>
            </div>
                                ...
                                <table style="width:900px; height: 0px; margin-right: 0px;">
                                    ...
                                    <tr>
                                        <td class="auto-style2">
                                            ...
                                            <asp:TextBox ID="tSrcDescription" runat="server"  Font-Bold="True" Font-Names="Myriad Pro" Font-Size="Medium" Font-Strikeout="False" Width="200"></asp:TextBox>
