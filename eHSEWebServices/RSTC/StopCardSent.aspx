    ...
    <div>
        ...
        <td class="style1">
            ...
            <asp:Label ID="Label1" runat="server" CssClass="Identificadores" 
                Width="600px" Height="16px"></asp:Label>
            <br />
        ...
        <asp:Button ID="btnBack" runat="server" Text="New Card / Nueva Tarjeta" CssClass="Button2" 
                Height="25px" PostBackUrl="~/StopCard.aspx" style="font-size: x-small" 
                Width="174px" />
