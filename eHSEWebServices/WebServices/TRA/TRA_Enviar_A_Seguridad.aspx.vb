...
Partial Class TRA_TRA_Enviar_A_Seguridad
    ...
    Protected Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        If Not Page.IsPostBack Then
            ...
            Catch ex As Exception
                Response.Write("Error, Hay Pedo grande, Saco conclusiones... " & ex.Message)
            End Try
        End If
    End Sub
    Protected Sub enviarBorrador()
        ...
        Email.To.Add(New MailAddress("RSTC@grbic.com"))
    ...
    Function cuerpoCorreo() As String
        ...
        "<tr><td height=""122"" align=""left"" valign=""middle"" style=""font-family: Verdana; font-size: small; font-weight: bold; font-style: normal;""><blockquote>" & _
            "<p>" & _
            "Se ha creado un nuevo TRA del departamento " & lDepartamento.Text & " y se ha mandado " & _
        ...
        "<tr><td></td><td><a href=""http://localhost:2468/TRA/TRA_Convertir_Oficial.aspx?Param=" & ltraId.Text & """><img src=""'cid:Image3'"" style=""height: 39px; width: 156px"" /></td><td></td></tr>" & _
        "<tr><td></td><td></td><td></td></tr>" & _
        "</table>" & _
        "</td></tr>" & _
