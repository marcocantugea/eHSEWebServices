<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRA_Enviar_Oficial.aspx.vb" Inherits="TRA_TRA_Enviar_Oficial" %>
            ...
            <tr>
                <td class="style2">
                    <table style="border: thin ridge #808080; width: 905px;">
                        ...
                        <tr>
                            <td class="auto-style11">
                                <asp:Label ID="lEnviarRev_Success0" runat="server" Text="This TRA has become Oficial to be used on board Bicentenario" Font-Names="Arial" style="font-size: small" Width="595px"></asp:Label>
                            </td>
